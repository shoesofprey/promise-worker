promise-worker-node [![Build Status](https://travis-ci.org/shoesofprey/promise-worker-node.svg?branch=master)](https://travis-ci.org/shoesofprey/promise-worker) [![Coverage Status](https://coveralls.io/repos/github/shoesofprey/promise-worker-node/badge.svg?branch=master)](https://coveralls.io/github/nolanlawson/promise-worker?branch=master)
====
